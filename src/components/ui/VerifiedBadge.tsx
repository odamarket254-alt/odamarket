    ...
    >
      <div 
        className={cn(
          ...
          isRegional ? "bg-[#C65A28]" : "bg-blue-600",
      ...
      {showText && (
        <span className={cn(
          ...
          isRegional ? "text-[#C65A28] dark:text-[#6B8E23]" : "text-blue-700 dark:text-blue-400",
          textClassName
        )}>
          {displayText}
        </span>
      ...
      <div 
        className={cn(
          ...
          "px-3 py-2.5 bg-[#3A2418] text-slate-100 dark:bg-[#E8DCC9] dark:text-[#3A2418]",
