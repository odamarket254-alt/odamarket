    ...
    <div className="space-y-6 max-w-[1600px] mx-auto pb-10">
      ...
      <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/admin/dashboard/wholesale/new"
        ...
        <div className="p-4 border-b border-[#E8DCC9] space-y-4">
          <div className="flex flex-col sm:flex-row justify-between gap-4">
            <div className="flex items-center gap-2 border-b sm:border-b-0 overflow-x-auto hide-scrollbar">
              {[
                { id: 'all', label: 'All Wholesale Products' },
                ...
                products.map((product) => (
                  <tr key={product.id} className={cn("hover:bg-[#FAF5EC] transition-colors group", selectedIds.includes(product.id) && "bg-[#E8DCC9]/30")}>
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="min-w-0">
                          <Link to={`/admin/dashboard/wholesale/${product.id}`} className="font-medium text-[#3A2418] hover:text-[#C65A28] truncate block transition-colors">
                            {product.name}
                          </Link>
                    ...
                    <td className="py-4 px-4 text-right">
                      <Link to={`/admin/dashboard/wholesale/${product.id}`} className="inline-flex p-2 text-[#8B857D] hover:text-[#C65A28] hover:bg-[#E8DCC9] rounded-lg transition-colors">
